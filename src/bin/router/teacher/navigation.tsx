...
export const teacherPublicRoutes: IAppRoute[] = [
  {
    component: lazy(() => import('@/bin/pages/teacher/home')),
  ...
  // Course
  {
    component: lazy(() => import('@/bin/pages/teacher/course/create')),
    path: TEACHER_URL_PAGE.COURSE.CHILD.CREATE.PATH,
    type: LAYOUT_TYPE.TEACHER,
    exact: true,
  },
  {
    component: lazy(() => import('@/bin/pages/teacher/course/list')),
    path: TEACHER_URL_PAGE.COURSE.CHILD.LIST.PATH,
    type: LAYOUT_TYPE.TEACHER,
    exact: true,
  },
  {
    component: lazy(() => import('@/bin/pages/teacher/course/detail')),
  ...
  // Class
  {
    component: lazy(() => import('@/bin/pages/teacher/class/create')),
    path: TEACHER_URL_PAGE.CLASS.CHILD.CREATE.PATH,
    type: LAYOUT_TYPE.TEACHER,
    exact: true,
  },
  {
    component: lazy(() => import('@/bin/pages/teacher/class/list')),
    path: TEACHER_URL_PAGE.CLASS.CHILD.LIST.PATH,
    type: LAYOUT_TYPE.TEACHER,
    exact: true,
  },
  {
    component: lazy(() => import('@/bin/pages/teacher/class/detail')),
  ...
  // Time Table
  {
    component: lazy(() => import('@/bin/pages/teacher/time-table/create')),
