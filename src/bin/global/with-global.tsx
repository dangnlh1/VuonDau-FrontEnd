...
import { useGlobalSelector } from '../hooks/use-global-selectors'
import { useGlobalAction } from '../hooks/use-global-actions'
...
const WithGlobal: React.FC<Props> = ({ renderHeader, isLoading, pageTitle, children }) => {
