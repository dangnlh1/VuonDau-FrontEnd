...
const AppPage: React.FC<Props> = () => {
  ...
  const classDetail = useMemo((): ClassDetail => {
    if (classDetailResponse.status === STATUS_CODES.OK) {
      if (classDetailResponse.data && !Array.isArray(classDetailResponse.data)) {
  ...
  return (
    <div className="class__detail__container">
      <div className="class__detail__heading">
        {classDetail.name} ({dateTimeToShow(classDetail.startDate, DATE_TIME_FORMAT.DATE_FORMAT)} -{' '}
      ...
      <div className="class__detail__student__container">
        ...
        >
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">HỌ VÀ TÊN</HeaderCell>
            <Cell
              children={(content: any) => {
                return (
                  <div className="class__detail__table__student__name">
                    <img className="img-response" src={content?.avatar} />
                    <div className="class__detail__student__name">{content?.name}</div>
                  </div>
                )
              }}
            />
          ...
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">NGÀY SINH</HeaderCell>
            <Cell
              dataKey="birthday"
          ...
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">TRẠNG THÁI</HeaderCell>
            <Cell
              dataKey="active"
          ...
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">BÀI TẬP ĐÃ LÀM</HeaderCell>
            <Cell
              dataKey=""
              renderCell={(content: any) => {
                return ''
          ...
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">ĐỀ THI ĐÃ LÀM</HeaderCell>
            <Cell
              dataKey=""
              renderCell={(content: any) => {
                return ''
          ...
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">EMAIL</HeaderCell>
            <Cell dataKey="email" />
          </Column>
          <Column flexGrow={1}>
            <HeaderCell className="class__detail__table__header">SỐ ĐIỆN THOẠI</HeaderCell>
