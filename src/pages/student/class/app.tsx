...
import {DATE_TIME_FORMAT, formatDate} from '@/common/function/date-time';
...
const AppPage: React.FC<Props> = React.memo(() => {
  ...
  const paymentRequest = useCallback(
    (request: paymentModels.PaymentRequest) =>
      dispatch(paymentActions.payment.request(request)),
    [dispatch],
  );

  const resetPayment = useCallback(
    (request: paymentModels.PaymentResponse) =>
      dispatch(paymentActions.payment.success(request)),
    [dispatch],
  );
  ...
  const resources = useMemo(() => {
    if (
      classDetail.course.resources &&
      classDetail.course.resources.length > 0
    ) {
    ...
    <div className="class__detail__section">
      <div className="class__detail__heading__section">
        <div className="class__detail__heading__container">
          <div className="class__detail__information">
            ...
            <div className="class__detail__subjectName">
          ...
          <div className="class__detail__cart">
            <div className="class__detail__cart__container">
              ...
              <div className="class__detail__button">
                <div
                  className="class__detail__add__to__cart"
            ...
            <div className="class__detail__cart__description">
              ...
              pariatur assumenda quidem repudiandae nihil doloremque nam labore
              cupiditate autem velit commodi ullam quas aperiam consequatur
              ipsum corporis voluptates, vitae explicabo?
            </div>
          </div>
        </div>
      </div>
      <div className="class__detail__course__detail__lesson__section">
        <div className="class__detail__course__detail__lesson__container">
          <div className="class__detail__course__detail__lesson__heading">
            Danh sách bài học
          </div>
