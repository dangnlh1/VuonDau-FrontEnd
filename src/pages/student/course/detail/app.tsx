...
import {initCourseDetail, STATUS_CODES} from '@/common/constants';
...
const AppPage: React.FC<Props> = () => {
  const courseDetailResponse: courseModels.CourseDetailResponse =
    useMemoriedSelector(courseSelectors.courseDetail).response;
  ...
  return (
    <div className="course__detail__section">
        ...
        <div className="course__detail__wrapper">
          <div className="course__detail__container">
            <div className="course__detail__information__container">
              ...
              <div className="course__detail__summary__description">
                {courseDetail.title}
              </div>
              <div className="course__detail__author">
                Giáo viên: {renderAuthor}
              </div>
      ...
      <div className="course__detail__lesson__container">
        ...
        <div className="course__detail__lesson__content">
          {renderLessonContent}
        </div>
      </div>
      <div className="course__detail__description">
        <div className="course__detail__description__wrapper">
          <div className="course__detail__description__title">
            What you'll learn
          </div>
          <div className="course__detail__description__heading">
