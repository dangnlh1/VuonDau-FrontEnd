...
export const studentPublicRoutes: IAppRoute[] = [
  ...
  {
    component: lazy(() => import('@/pages/authentication/teacher')),
    path: STUDENT_URL_PAGE.TEACHER_REGISTER.PATH,
    type: LAYOUT_TYPE.STUDENT,
    exact: true,
  },
  {
    component: lazy(() => import('@/pages/student/home')),
    path: STUDENT_URL_PAGE.HOME.PATH,
    type: LAYOUT_TYPE.STUDENT,
    exact: true,
  },
  {
    component: lazy(() => import('@/pages/student/course/list')),
    path: STUDENT_URL_PAGE.COURSE.PATH,
    type: LAYOUT_TYPE.STUDENT,
    exact: true,
  },
  {
    component: lazy(() => import('@/pages/student/course/detail')),
    path: STUDENT_URL_PAGE.COURSE.CHILD.DETAIL.PATH,
    type: LAYOUT_TYPE.STUDENT,
    exact: true,
  },
  {
    component: lazy(() => import('@/pages/student/class')),
    path: STUDENT_URL_PAGE.CLASS.CHILD.DETAIL.PATH,
    type: LAYOUT_TYPE.STUDENT,
    exact: true,
  },
  {
    component: lazy(() => import('@/pages/student/search')),
