    ...
    <div className="student__side__nav">
      <Navbar className="student__side__nav__bar">
        <div className="student__side__nav__bar__left">
          <Navbar.Brand
            onClick={() => handleOnRedirect(STUDENT_URL_PAGE.HOME.PATH)}
          >
        ...
        <div className="student__side__nav__bar__right">
          <Nav>
            <Nav.Item
              onClick={() =>
                handleOnRedirect(STUDENT_URL_PAGE.TEACHER_REGISTER.PATH)
              }
              active={selectedRoute.includes(
                STUDENT_URL_PAGE.TEACHER_REGISTER.PATH,
              )}
            >
            ...
            {keycloak.authenticated ? (
              <React.Fragment>
                <Nav.Menu title={keycloak.idTokenParsed?.preferred_username}>
                  {roles?.includes('TEACHER') ? (
                    <Nav.Item
                      onClick={() =>
                        handleOnRedirect(TEACHER_URL_PAGE.HOME.PATH)
                      }
                      active={selectedRoute.includes(
                        TEACHER_URL_PAGE.HOME.PATH,
                      )}
                    >
                      Giáo viên
                    </Nav.Item>
              ...
              <React.Fragment>
                ...
                <Nav.Item
                  onClick={() =>
                    handleOnRedirect(STUDENT_URL_PAGE.REGISTER.PATH)
                  }
                  active={selectedRoute.includes(
                    STUDENT_URL_PAGE.REGISTER.PATH,
                  )}
                >
                  Đăng ký
                </Nav.Item>
